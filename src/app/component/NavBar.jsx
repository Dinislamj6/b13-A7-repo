    ...
    return (
        <div className="bg-base-100 shadow-sm">
            <div className="navbar max-w-7xl mx-auto">
                <div className="md:navbar-start justify-between w-full flex">
                     ...
                     <div className="dropdown ">
                        ...
                        <ul
                            tabIndex="-1"
                            className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-40 ml-[-40px] p-2 gap-3 shadow">
                            {links}
                        </ul>
                    </div>
